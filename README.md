...
> [!IMPORTANT]
> Since v1.0.0, this config is rewritten to the new [ESLint Flat config](https://eslint.org/docs/latest/use/configure/configuration-files-new), check the [release note](https://github.com/nika/eslint-config/releases/tag/v1.0.0) for more details.
...
```bash
npx @zhangwj0520/eslint-config@latest
```
...
Normally you only need to import the `nika` preset:
...
The `nika` factory function also accepts any number of arbitrary custom config overrides:
...
Check out the [configs](https://github.com/nika/eslint-config/blob/main/src/configs) and [factory](https://github.com/nika/eslint-config/blob/main/src/factory.ts) for more details.
...
Since v2.10.0, the factory function `nika()` returns a [`FlatConfigComposer` object from `eslint-flat-config-utils`](https://github.com/nika/eslint-flat-config-utils#composer) where you can chain the methods to compose the config even more flexibly.
...
Use external formatters to format files that ESLint cannot handle yet (`.css`, `.html`, etc). Powered by [`eslint-plugin-format`](https://github.com/nika/eslint-plugin-format).
...
```md
[![code style](https://nika.me/badge-code-style.svg)](https://github.com/nika/eslint-config)
```
...
[Why I don't use Prettier](https://nika.me/posts/why-not-prettier)
...
- [nika/dotfiles](https://github.com/nika/dotfiles) - My dotfiles
- [nika/vscode-settings](https://github.com/nika/vscode-settings) - My VS Code settings
- [nika/starter-ts](https://github.com/nika/starter-ts) - My starter template for TypeScript library
- [nika/vitesse](https://github.com/nika/vitesse) - My starter template for Vue & Vite app

## License

[MIT](./LICENSE) License &copy; 2019-PRESENT [Anthony Fu](https://github.com/nika)
